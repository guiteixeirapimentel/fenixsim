...
Cube::Cube(ID3D11Device* pDevice)
	:
	...
	cPVertexBuffer(nullptr)
{
	...
	*/
	...
	{
		// Front Face
		{ {-0.5f, -0.5f, -0.5f, 0.0f}, {onethird, half}, {0.0f, 0.0f, -1.0f}} ,
		{ { -0.5f,  0.5f, -0.5f, 0.0f}, {onethird, zero},{ 0.0f, 0.0f, -1.0f } },
		{ { 0.5f,  0.5f, -0.5f, 0.0f}, { twothirds, zero},{ 0.0f, 0.0f, -1.0f } },
		{ { 0.5f, -0.5f, -0.5f, 0.0f }, { twothirds, half},{ 0.0f, 0.0f, -1.0f } },

		// Back Face
		{{-0.5f, -0.5f, 0.5f, 0.0f}, { twothirds,one  }, { 0.0f, 0.0f, 1.0f } },
		{{0.5f, -0.5f, 0.5f, 0.0f}, { onethird , one },{ 0.0f, 0.0f, 1.0f } },
		{{0.5f,  0.5f, 0.5f, 0.0f}, { onethird,  half },{ 0.0f, 0.0f, 1.0f } },
		{{-0.5f,  0.5f, 0.5f, 0.0f}, { twothirds, half },{ 0.0f, 0.0f, 1.0f } },

		// Top Face
		{{-0.5f, 0.5f, -0.5f, 0.0f},{ zero, one},{ 0.0f, 1.0f, 0.0f }},
		{{-0.5f, 0.5f,  0.5f,0.0f},{ zero, half},{ 0.0f, 1.0f, 0.0f } },
		{{0.5f, 0.5f,  0.5f, 0.0f},{ onethird, half },{ 0.0f, 1.0f, 0.0f } },
		{{0.5f, 0.5f, -0.5f, 0.0f}, { onethird, one },{ 0.0f, 1.0f, 0.0f } },

		// Bottom Face
		{{-0.5f, -0.5f, -0.5f,0.0f}, {one, half },{ 0.0f, -1.0f, 0.0f } },
		{{0.5f, -0.5f, -0.5f,0.0f }, {twothirds, half },{ 0.0f, -1.0f, 0.0f } },
		{{0.5f, -0.5f,  0.5f,0.0f }, { twothirds, zero },{ 0.0f, -1.0f, 0.0f } },
		{{-0.5f, -0.5f,  0.5f,0.0f }, { one, zero },{ 0.0f, -1.0f, 0.0f } },

		// Left Face
		{{-0.5f, -0.5f,  0.5f,0.0f }, {zero, half },{ -1.0f, 0.0f, 0.0f } },
		{{-0.5f,  0.5f,  0.5f,0.0f }, {zero, zero },{ -1.0f, 0.0f, 0.0f } },
		{{-0.5f,  0.5f, -0.5f,0.0f }, {onethird, zero },{ -1.0f, 0.0f, 0.0f } },
		{{-0.5f, -0.5f, -0.5f,0.0f }, {onethird, half },{ -1.0f, 0.0f, 0.0f } },

		// Right Face
		{{0.5f, -0.5f, -0.5f,0.0f }, {twothirds, one },{ 1.0f, 0.0f, 0.0f } },
		{{0.5f,  0.5f, -0.5f,0.0f }, {twothirds, half},{ 1.0f, 0.0f, 0.0f } },
		{{0.5f,  0.5f,  0.5f,0.0f }, {one, half },{ 1.0f, 0.0f, 0.0f } },
		{{0.5f, -0.5f,  0.5f,0.0f }, { one, one },{ 1.0f, 0.0f, 0.0f } }
	};
...
ID3D11Buffer* Cube::GetVertexBuffer() const
{
	return cPVertexBuffer;
}

ID3D11Buffer* Cube::GetIndexBuffer() const
{
